    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title"> Mes Aliments </h2>
                    <table>
                        <tr>
                            <th>idaliment</th>
                            <th>nom Aliment</th>
                        ...
                        <tr>
                            <th><?php echo $aliment->idaliment; ?></th>
                            <th><?php echo $aliment->nomaliment; ?></th>
                            <th><a href='<?php echo site_url("Crud/supprimerAliment")."idaliment=".$aliment->idaliment; ?>'> Delete</a></th>
                        </tr>
                        <?php } ?>
                    </table>
                </div>
